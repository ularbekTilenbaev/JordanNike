                ...
                <div className="">
                    <div className="flex items-center justify-between pt-[700px]">
                        ...
                        <div className=" flex text-2xl gap-10 ml-[-9pc]">
                            <button onClick={() =>nav("/addProduct")} className='bg-white text-black py-[10px] px-[30px]'>ADD TO CART</button>
                            <button onClick={() =>nav('/buynow')} className='bg-black text-white py-[10px] px-[30px] border-2 border-inherit'>BUY NOW</button>
                        </div>
                      <div className="">
